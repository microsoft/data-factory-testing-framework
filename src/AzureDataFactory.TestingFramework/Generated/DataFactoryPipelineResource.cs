...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFactoryPipelineResource : ArmResource
    {
        ...
        private readonly Pipeline _data;
        ...
        internal DataFactoryPipelineResource(ArmClient client, Pipeline data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<DataFactoryPipelineResource>> UpdateAsync(WaitUntil waitUntil, Pipeline data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<DataFactoryPipelineResource> Update(WaitUntil waitUntil, Pipeline data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
