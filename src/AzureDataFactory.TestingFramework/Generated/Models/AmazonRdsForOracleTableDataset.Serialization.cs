...
{
    public partial class AmazonRdsForOracleTableDataset : IUtf8JsonSerializable
    {
        ...
        internal static AmazonRdsForOracleTableDataset DeserializeAmazonRdsForOracleTableDataset(JsonElement element)
        {
