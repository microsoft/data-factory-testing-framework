...
namespace AzureDataFactory.TestingFramework.Models
{
    public partial class GreenplumSource : IUtf8JsonSerializable
    {
        ...
        internal static GreenplumSource DeserializeGreenplumSource(JsonElement element)
        {
            ...
            return new GreenplumSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, queryTimeout.Value, additionalColumns.Value, query.Value);
        }
    }
}
