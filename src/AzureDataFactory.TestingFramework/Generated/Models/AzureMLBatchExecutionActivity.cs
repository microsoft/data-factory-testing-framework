...
namespace AzureDataFactory.TestingFramework.Models
{
    ...
    public partial class AzureMLBatchExecutionActivity : ExecutionActivity
    {
        ...
        public AzureMLBatchExecutionActivity(string name) : base(name)
        {
            ...
            GlobalParameters = new ChangeTrackingDictionary<string, DataFactoryElement<string>>();
        ...
        internal AzureMLBatchExecutionActivity(string name, string activityType, string description, PipelineActivityState? state, ActivityOnInactiveMarkAs? onInactiveMarkAs, IList<PipelineActivityDependency> dependsOn, IList<PipelineActivityUserProperty> userProperties, IDictionary<string, DataFactoryElement<string>> additionalProperties, DataFactoryLinkedServiceReference linkedServiceName, PipelineActivityPolicy policy, IDictionary<string, DataFactoryElement<string>> globalParameters, IDictionary<string, AzureMLWebServiceFile> webServiceOutputs, IDictionary<string, AzureMLWebServiceFile> webServiceInputs) : base(name, activityType, description, state, onInactiveMarkAs, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
        ...
        /// </para>
        /// </summary>
        public IDictionary<string, DataFactoryElement<string>> GlobalParameters { get; }
