...
namespace AzureDataFactory.TestingFramework.Models
{
    public partial class AzureSearchIndexDataset : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            JsonSerializer.Serialize(writer, IndexName);
            writer.WriteEndObject();
        ...
        internal static AzureSearchIndexDataset DeserializeAzureSearchIndexDataset(JsonElement element)
        {
            ...
            DataFactoryElement<string> indexName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("indexName"u8))
                        {
                            indexName = JsonSerializer.Deserialize<DataFactoryElement<string>>(property0.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
