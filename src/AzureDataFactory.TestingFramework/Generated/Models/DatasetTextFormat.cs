...
namespace AzureDataFactory.TestingFramework.Models
{
    ...
    public partial class DatasetTextFormat : DatasetStorageFormat
    {
        ...
        internal DatasetTextFormat(string datasetStorageFormatType, DataFactoryElement<string> serializer, DataFactoryElement<string> deserializer, IDictionary<string, DataFactoryElement<string>> additionalProperties, DataFactoryElement<string> columnDelimiter, DataFactoryElement<string> rowDelimiter, DataFactoryElement<string> escapeChar, DataFactoryElement<string> quoteChar, DataFactoryElement<string> nullValue, DataFactoryElement<string> encodingName, DataFactoryElement<bool> treatEmptyAsNull, DataFactoryElement<int> skipLineCount, DataFactoryElement<bool> firstRowAsHeader) : base(datasetStorageFormatType, serializer, deserializer, additionalProperties)
        {
