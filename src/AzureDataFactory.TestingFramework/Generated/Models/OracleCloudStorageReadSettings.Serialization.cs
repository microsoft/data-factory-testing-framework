...
{
    public partial class OracleCloudStorageReadSettings : IUtf8JsonSerializable
    {
        ...
        internal static OracleCloudStorageReadSettings DeserializeOracleCloudStorageReadSettings(JsonElement element)
        {
