...
namespace AzureDataFactory.TestingFramework.Models
{
    public partial class PhoenixSource : IUtf8JsonSerializable
    {
        ...
        internal static PhoenixSource DeserializePhoenixSource(JsonElement element)
        {
            ...
            return new PhoenixSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, queryTimeout.Value, additionalColumns.Value, query.Value);
        }
    }
}
