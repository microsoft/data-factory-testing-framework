...
namespace AzureDataFactory.TestingFramework.Models
{
    ...
    public partial class ParquetWriteSettings : FormatWriteSettings
    {
        ...
        internal ParquetWriteSettings(string formatWriteSettingsType, IDictionary<string, DataFactoryElement<string>> additionalProperties, DataFactoryElement<int> maxRowsPerFile, DataFactoryElement<string> fileNamePrefix) : base(formatWriteSettingsType, additionalProperties)
        {
