...
namespace AzureDataFactory.TestingFramework.Models
{
    ...
    public partial class CosmosDBMongoDBApiSource : CopyActivitySource
    {
        /// <summary> Initializes a new instance of CosmosDBMongoDBApiSource. </summary>
        public CosmosDBMongoDBApiSource()
        {
            CopySourceType = "CosmosDbMongoDbApiSource";
        }
        ...
        internal CosmosDBMongoDBApiSource(string copySourceType, DataFactoryElement<int> sourceRetryCount, DataFactoryElement<string> sourceRetryWait, DataFactoryElement<int> maxConcurrentConnections, DataFactoryElement<bool> disableMetricsCollection, IDictionary<string, DataFactoryElement<string>> additionalProperties, DataFactoryElement<string> filter, MongoDBCursorMethodsProperties cursorMethods, DataFactoryElement<int> batchSize, DataFactoryElement<string> queryTimeout, BinaryData additionalColumns) : base(copySourceType, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Filter = filter;
            ...
            CopySourceType = copySourceType ?? "CosmosDbMongoDbApiSource";
        }
