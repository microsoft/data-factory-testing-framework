...
namespace AzureDataFactory.TestingFramework.Models
{
    public partial class WebHookActivity : IUtf8JsonSerializable
    {
        ...
        internal static WebHookActivity DeserializeWebHookActivity(JsonElement element)
        {
            ...
            Optional<Dictionary<string, DataFactoryElement<string>>> headers = default;
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("headers"u8))
                        {
                            ...
                            headers = JsonSerializer.Deserialize<Dictionary<string, DataFactoryElement<string>>>(property0.Value.GetRawText());
                            continue;
                        }
