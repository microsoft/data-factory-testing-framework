...
namespace AzureDataFactory.TestingFramework.Models
{
    ...
    public partial class CustomActivity : ExecutionActivity
    {
        ...
        public CustomActivity(string name, DataFactoryElement<string> command) : base(name)
        {
            ...
            Command = command;
            ExtendedProperties = new ChangeTrackingDictionary<string, DataFactoryElement<string>>();
            ActivityType = "Custom";
        }
        ...
        internal CustomActivity(string name, string activityType, string description, PipelineActivityState? state, ActivityOnInactiveMarkAs? onInactiveMarkAs, IList<PipelineActivityDependency> dependsOn, IList<PipelineActivityUserProperty> userProperties, IDictionary<string, DataFactoryElement<string>> additionalProperties, DataFactoryLinkedServiceReference linkedServiceName, PipelineActivityPolicy policy, DataFactoryElement<string> command, DataFactoryLinkedServiceReference resourceLinkedService, DataFactoryElement<string> folderPath, CustomActivityReferenceObject referenceObjects, IDictionary<string, DataFactoryElement<string>> extendedProperties, BinaryData retentionTimeInDays, DataFactoryElement<string> autoUserSpecification) : base(name, activityType, description, state, onInactiveMarkAs, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
            Command = command;
        ...
        /// </para>
        /// </summary>
        public IDictionary<string, DataFactoryElement<string>> ExtendedProperties { get; }
        /// <summary>
