...
namespace AzureDataFactory.TestingFramework.Models
{
    ...
    public partial class MapperAttributeMapping
    {
        ...
        internal MapperAttributeMapping(string name, MappingType? mappingType, string functionName, string expression, MapperAttributeReference attributeReference, IList<MapperAttributeReference> attributeReferences)
        {
            Name = name;
