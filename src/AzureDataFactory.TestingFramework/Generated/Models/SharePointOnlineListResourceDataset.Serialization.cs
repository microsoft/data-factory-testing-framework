    ...
    public partial class SharePointOnlineListResourceDataset : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(ListName))
            {
                ...
                JsonSerializer.Serialize(writer, ListName);
            }
            writer.WriteEndObject();
        ...
        internal static SharePointOnlineListResourceDataset DeserializeSharePointOnlineListResourceDataset(JsonElement element)
        {
            ...
            Optional<DataFactoryElement<string>> listName = default;
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("listName"u8))
                        {
                            ...
                            listName = JsonSerializer.Deserialize<DataFactoryElement<string>>(property0.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
