...
namespace AzureDataFactory.TestingFramework.Models
{
    public partial class JiraSource : IUtf8JsonSerializable
    {
        ...
        internal static JiraSource DeserializeJiraSource(JsonElement element)
        {
            ...
            return new JiraSource(type, sourceRetryCount.Value, sourceRetryWait.Value, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, queryTimeout.Value, additionalColumns.Value, query.Value);
        }
    }
}
