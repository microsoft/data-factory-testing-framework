...
namespace AzureDataFactory.TestingFramework.Models
{
    ...
    public partial class MarketoObjectDataset : DataFactoryDatasetProperties
    {
        ...
        public MarketoObjectDataset(DataFactoryLinkedServiceReference linkedServiceName) : base(linkedServiceName)
        {
            Argument.AssertNotNull(linkedServiceName, nameof(linkedServiceName));

            DatasetType = "MarketoObject";
        }
        ...
        {
            TableName = tableName;
            DatasetType = datasetType ?? "MarketoObject";
        }
