    ...
    public partial class CassandraTableDataset : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(Keyspace))
            {
                ...
                JsonSerializer.Serialize(writer, Keyspace);
            }
            writer.WriteEndObject();
        ...
        internal static CassandraTableDataset DeserializeCassandraTableDataset(JsonElement element)
        {
            ...
            Optional<DataFactoryElement<string>> keyspace = default;
                ...
                if (property.NameEquals("typeProperties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("keyspace"u8))
                        {
                            ...
                            keyspace = JsonSerializer.Deserialize<DataFactoryElement<string>>(property0.Value.GetRawText());
                            continue;
                        }
                    }
                    continue;
