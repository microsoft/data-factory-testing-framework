...
#pragma warning disable SA1649 // File name should match first type name
    internal class DataFactoryArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal<T> _operation;

        /// <summary> Initializes a new instance of DataFactoryArmOperation for mocking. </summary>
        protected DataFactoryArmOperation()
        {
        }

        internal DataFactoryArmOperation(Response<T> response)
        {
            _operation = OperationInternal<T>.Succeeded(response.GetRawResponse(), response.Value);
        }

        internal DataFactoryArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(nextLinkOperation, clientDiagnostics, response, "DataFactoryArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
