...
{
    public partial class Pipeline : IUtf8JsonSerializable
    {
        ...
        internal static Pipeline DeserializeDataFactoryPipelineData(JsonElement element)
        {
            ...
            Optional<IDictionary<string, DataFactoryElement<string>>> runDimensions = default;
