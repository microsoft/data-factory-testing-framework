...
namespace AzureDataFactory.TestingFramework.Models
{
    ...
    public partial class FileServerLocation : DatasetLocation
    {
        ...
        internal FileServerLocation(string datasetLocationType, DataFactoryElement<string> folderPath, DataFactoryElement<string> fileName, IDictionary<string, DataFactoryElement<string>> additionalProperties) : base(datasetLocationType, folderPath, fileName, additionalProperties)
        {
