...
def test_utcnow() -> None:
    # Arrange
    CSharpDateTime.utcnow = lambda: CSharpDateTime.parse("2023-11-24T12:11:54.7531321Z")
...
def test_get_future_time(interval: int, time_unit: str, expected: str) -> None:
    CSharpDateTime.utcnow = lambda: CSharpDateTime.parse("2023-11-24T12:11:49.7531321Z")
